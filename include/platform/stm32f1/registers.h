...
#define GPIO_MODE_IN_FLOAT              (uint32_t) (0x04)                                       /* Input floating point mode */
#define GPIO_MODE_IN_PD                 (uint32_t) (0x28)                                       /* Input push down mode */
#define GPIO_MODE_IN_PU                 (uint32_t) (0x48)                                       /* Input pull up mode */
#define GPIO_MODE_OUT_PP                (uint32_t) (0x10)                                       /* Output push-pull mode */
#define GPIO_MODE_OUT_OD                (uint32_t) (0x14)                                       /* Output open-drain mode */
#define GPIO_MODE_OUT_ALT_PP            (uint32_t) (0x18)                                       /* Output alternate function push-pull mode */
#define GPIO_MODE_OUT_ALT_OD            (uint32_t) (0x1C)                                       /* Output alternate function open-drain mode */
